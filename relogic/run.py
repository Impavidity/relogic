...
from relogic.utils.dataset import TokenizedDataset
from relogic.utils.trainer import EvaluateFriendlySeq2SeqTrainer
from relogic.utils.training_arguments import WrappedSeq2SeqTrainingArguments
from relogic.utils import crash_on_ipy
...
def main() -> None:
    ...
    if not args.arg_paths:
        ...
        seq2seq_dataset_split: tuple = tool.get_constructor(args.seq2seq.constructor)(args).to_seq2seq(
        ...
        for task, arg_path in args.arg_paths:
            ...
            task_seq2seq_dataset_split: tuple = tool.get_constructor(task_args.seq2seq.constructor)(task_args).\
                to_seq2seq(task_raw_datasets_split, cache_root)

            meta_tuning_data[arg_path] = task_seq2seq_dataset_split

        seq2seq_dataset_split: tuple = tool.get_constructor(args.seq2seq.constructor)(args).\
            to_seq2seq(meta_tuning_data)

    evaluator = tool.get_evaluator(args.evaluate.tool)(args)
    model = tool.get_model(args.model.name)(args)
